...
namespace BCL.Persistence.Sqlite.Migrations
{
    ...
    [Migration("20220430174629_AddedAliasesToChampionsAndMaps")]
    partial class AddedAliasesToChampionsAndMaps
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BCL.Domain.Entities.Queue.Alias", b =>
                {
            ...
            modelBuilder.Entity("BCL.Domain.Entities.Queue.DraftStep", b =>
                {
                    ...
                    b.HasIndex("Champion1Id");

                    b.HasIndex("Champion2Id");
            ...
            modelBuilder.Entity("BCL.Domain.Entities.Queue.Alias", b =>
                {
                    ...
                    b.HasOne("BCL.Domain.Entities.Queue.Map", null)
                        .WithMany("Aliases")
                        .HasForeignKey("MapId");
                });
            ...
            modelBuilder.Entity("BCL.Domain.Entities.Queue.DraftStep", b =>
                {
                    b.HasOne("BCL.Domain.Entities.Queue.Champion", "Champion1")
                        .WithMany()
                        .HasForeignKey("Champion1Id");

                    b.HasOne("BCL.Domain.Entities.Queue.Champion", "Champion2")
                        .WithMany()
                        .HasForeignKey("Champion2Id");

                    b.HasOne("BCL.Domain.Entities.Queue.Draft", null)
                        .WithMany("Steps")
                        .HasForeignKey("DraftId");

                    b.HasOne("BCL.Domain.Entities.Queue.Map", "Map1")
                        .WithMany()
                        .HasForeignKey("Map1Id");

                    b.HasOne("BCL.Domain.Entities.Queue.Map", "Map2")
                        .WithMany()
                        .HasForeignKey("Map2Id");

                    b.Navigation("Champion1");

                    b.Navigation("Champion2");
